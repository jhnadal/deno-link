  ...
  return (
    <html data-theme="dark" lang="en">
      <head>
        ...
        <meta
          name="description"
          content="This is a link shortener app created with the solely purpose of learning features of Deno."
        ></meta>
        ...
        <div className="hero-content text-center">
          <div className="max-w-lg">
            ...
            <p className="py-6">
              ...
              basic Deno APIs to Create, manage, and track your links with
